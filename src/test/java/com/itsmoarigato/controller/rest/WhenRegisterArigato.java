...
public class WhenRegisterArigato {
	...
	public void 一覧を取得するテスト() throws Exception {
		...
		assertThat(response, is("{\"id\":0,\"fromUser\":null,\"toUser\":null,\"subject\":null,\"message\":null,\"images\":null}"));
	}
	...
	public void 詳細を取得するテスト() throws Exception {
		...
		assertThat(response, is("{\"id\":1,\"fromUser\":null,\"toUser\":null,\"subject\":null,\"message\":null,\"images\":null}"));
	}
